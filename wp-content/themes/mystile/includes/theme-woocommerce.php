...
function woo_wc_search_form( $form ) {
    ...
    <input autosave="'. esc_url(home_url( '/' )) .'" class="input-text" placeholder="'. esc_attr__( 'Search', 'woothemes' ) .'" value="' . get_search_query() . '" name="s" id="s" />
...
function woo_wc_search_form2( $form ) {
...
function woocommerce_cart_link() {
	...
	echo 'Cart';
	echo '<span class="contents2">' . sprintf(_n('%d ', '%d ', $woocommerce->cart->get_cart_contents_count(), 'woothemes'), $woocommerce->cart->get_cart_contents_count()) . '</span>';
	?>
	</span>
	</a>
	</li>
