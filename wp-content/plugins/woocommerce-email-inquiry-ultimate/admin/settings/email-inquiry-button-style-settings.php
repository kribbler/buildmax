...
class WC_EI_Button_Style_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function after_save_settings() {
		...
		if ( isset( $_POST['bt_save_settings'] ) && isset( $_POST['wc_email_inquiry_reset_products_button_style_options'] ) ) {
			delete_option( 'wc_email_inquiry_reset_products_button_style_options' );
