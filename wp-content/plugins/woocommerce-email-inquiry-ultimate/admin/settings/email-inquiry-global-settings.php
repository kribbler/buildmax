...
class WC_EI_Global_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function after_save_settings() {
		if ( isset( $_POST['bt_save_settings'] ) && isset( $_POST['wc_email_inquiry_reset_products_options'] ) ) {
			delete_option( 'wc_email_inquiry_reset_products_options' );
			WC_Email_Inquiry_Functions::reset_products_to_global_settings();				
		}
		if ( get_option( 'wc_email_inquiry_ultimate_clean_on_deletion' ) == 0  )  {
		...
		$roles = $wp_roles->get_names();
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'id' 		=> 'wc_email_inquiry_ultimate_clean_on_deletion',
				'type' 		=> 'onoff_checkbox',
				'default'	=> '1',
				'separate_option'	=> true,
				'checked_value'		=> '1',
