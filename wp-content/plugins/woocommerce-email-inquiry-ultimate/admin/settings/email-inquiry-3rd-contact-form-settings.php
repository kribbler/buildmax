...
class WC_EI_3RD_Contact_Form_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function after_save_settings() {
		if ( isset( $_POST['bt_save_settings'] ) && isset( $_POST['wc_email_inquiry_reset_products_shortcode_options'] ) ) {
			delete_option( 'wc_email_inquiry_reset_products_shortcode_options' );
