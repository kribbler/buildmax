<?php
/*
Plugin Name: WooCommerce Email Inquiry Ultimate
Description: Transform your entire WooCommerce products catalog or any individual product into an online brochure with Product Email Inquiry button. Use Role based Rules to 'Hide add to Cart', Hide Prices, show Email Inquiry button. Use Gravity Forms or Contact Form 7 to make customized Inquiry forms.
Version: 1.0.9
Author: A3 Revolution
Author URI: http://www.a3rev.com/
License: This software is under commercial license and copyright to A3 Revolution Software Development team

	WooCommerce Email Inquiry Ultimate. Plugin for the WooCommerce shopping Cart.
...
define('WC_EMAIL_INQUIRY_WP_TESTED', '3.8.1' );
if(!defined("WC_EMAIL_INQUIRY_MANAGER_URL"))
    define("WC_EMAIL_INQUIRY_MANAGER_URL", "http://a3api.com/plugins");
...
function wc_email_inquiry_ultimate_uninstall(){
	if ( get_option('wc_email_inquiry_ultimate_clean_on_deletion') == 1 ) {
		...
		global $wpdb;
		$string_ids = $wpdb->get_col("SELECT id FROM {$wpdb->prefix}icl_strings WHERE context='WC Email Inquiry Ultimate' ");
...
if ( get_option('wc_email_inquiry_ultimate_clean_on_deletion') == 1 ) {
	register_uninstall_hook( __FILE__, 'wc_email_inquiry_ultimate_uninstall' );
}
?>
